          ...
          <div className="relative">
            ...
            <div className="mt-8 flex justify-center select-none">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-xs sm:text-sm text-base-soft hover:text-cyan-brand transition-colors font-display tracking-widest uppercase font-bold"
              >
